...
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1387_get_creationDate,"openfl.net.FileReference","get_creationDate",0x7abf2144,"openfl.net.FileReference.get_creationDate","openfl/net/FileReference.hx",1387,0x825195e0)
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1391_get_modificationDate,"openfl.net.FileReference","get_modificationDate",0x2ae07e81,"openfl.net.FileReference.get_modificationDate","openfl/net/FileReference.hx",1391,0x825195e0)
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1395_get_name,"openfl.net.FileReference","get_name",0xbe63dea2,"openfl.net.FileReference.get_name","openfl/net/FileReference.hx",1395,0x825195e0)
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1400_get_size,"openfl.net.FileReference","get_size",0xc1b80d18,"openfl.net.FileReference.get_size","openfl/net/FileReference.hx",1400,0x825195e0)
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1405_get_type,"openfl.net.FileReference","get_type",0xc26d5f11,"openfl.net.FileReference.get_type","openfl/net/FileReference.hx",1405,0x825195e0)
namespace openfl{
namespace net{
...
HX_DEFINE_DYNAMIC_FUNC1(FileReference_obj,urlLoader_onProgress,(void))
 ...
 ::Date FileReference_obj::get_creationDate(){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1387_get_creationDate)
HXDLIN(1387)		return this->creationDate;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FileReference_obj,get_creationDate,return )
 ...
 ::Date FileReference_obj::get_modificationDate(){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1391_get_modificationDate)
HXDLIN(1391)		return this->modificationDate;
            	}
...
::String FileReference_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1395_get_name)
HXDLIN(1395)		return this->name;
            	}
...
int FileReference_obj::get_size(){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1400_get_size)
HXDLIN(1400)		return this->size;
            	}
...
::String FileReference_obj::get_type(){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1405_get_type)
HXDLIN(1405)		return this->type;
            	}
