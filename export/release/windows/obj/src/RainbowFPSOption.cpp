...
HX_DEFINE_STACK_FRAME(_hx_pos_7861c1e414cf422e_434_new,"RainbowFPSOption","new",0xb4ce913a,"RainbowFPSOption.new","Options.hx",434,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_440_press,"RainbowFPSOption","press",0xa1d87edd,"RainbowFPSOption.press","Options.hx",440,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7861c1e414cf422e_449_updateDisplay,"RainbowFPSOption","updateDisplay",0xe58aa493,"RainbowFPSOption.updateDisplay","Options.hx",449,0x9d9a0240)

void RainbowFPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_434_new)
HXLINE( 435)		super::__construct();
HXLINE( 436)		this->description = desc;
            	}
...
bool RainbowFPSOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_440_press)
HXLINE( 441)		::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 442)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->changeFPSColor(-1);
HXLINE( 443)		this->display = this->updateDisplay();
HXLINE( 444)		return true;
            	}


::String RainbowFPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7861c1e414cf422e_449_updateDisplay)
HXDLIN( 449)		::String _hx_tmp;
HXDLIN( 449)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic)) ))) {
HXDLIN( 449)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 449)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 449)		return (HX_("FPS Rainbow ",81,45,9e,9c) + _hx_tmp);
            	}
