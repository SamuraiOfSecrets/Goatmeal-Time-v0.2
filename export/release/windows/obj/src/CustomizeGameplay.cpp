...
HX_DEFINE_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_519_new,"CustomizeGameplay","new",0xb144179b,"CustomizeGameplay.new","Options.hx",519,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_525_press,"CustomizeGameplay","press",0xcb851f7e,"CustomizeGameplay.press","Options.hx",525,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_533_updateDisplay,"CustomizeGameplay","updateDisplay",0x26aa4e34,"CustomizeGameplay.updateDisplay","Options.hx",533,0x9d9a0240)

void CustomizeGameplay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_519_new)
HXLINE( 520)		super::__construct();
HXLINE( 521)		this->description = desc;
            	}
...
bool CustomizeGameplay_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_525_press)
HXLINE( 526)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source_ian/Options.hx",7d,53,7f,86),526,HX_("CustomizeGameplay",29,ae,ab,0c),HX_("press",83,53,88,c8)));
HXLINE( 527)		{
HXLINE( 527)			 ::flixel::FlxState nextState =  ::GameplayCustomizeState_obj::__alloc( HX_CTX ,null(),null());
...
::String CustomizeGameplay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_533_updateDisplay)
HXDLIN( 533)		return HX_("Customize Gameplay",a3,2e,c4,04);
            	}
