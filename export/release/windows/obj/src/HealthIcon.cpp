...
HXLINE(  29)		this->animation->add(HX_("bf-old",5e,ba,eb,07),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_12,2),0,false,isPlayer,null());
HXLINE(  30)		this->animation->add(HX_("gf",1f,5a,00,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_13,1),0,false,isPlayer,null());
HXLINE(  31)		this->animation->add(HX_("gf-christmas",94,26,b1,6d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_14,1),0,false,isPlayer,null());
HXLINE(  32)		this->animation->add(HX_("gf-pixel",98,3e,8c,55),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_15,1),0,false,isPlayer,null());
HXLINE(  33)		this->animation->add(HX_("parents-christmas",fe,94,c5,32),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_16,2),0,false,isPlayer,null());
HXLINE(  34)		this->animation->add(HX_("monster",1a,54,b0,b8),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_17,2),0,false,isPlayer,null());
HXLINE(  35)		this->animation->add(HX_("monster-christmas",4f,88,85,27),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_18,2),0,false,isPlayer,null());
HXLINE(  36)		this->animation->add(HX_("bf-pixel",fd,03,90,37),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_19,2),0,false,isPlayer,null());
...
HXLINE(  40)		this->animation->add(HX_("ian",96,01,50,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
