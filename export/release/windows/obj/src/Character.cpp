...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_543_update,"Character","update",0x0e18944e,"Character.update","Character.hx",543,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_579_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",579,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_640_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",640,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_671_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",671,0xf073a2d5)
...
HXLINE( 109)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("ian",96,01,50,00)) ){
HXLINE( 500)			::String library = null();
HXDLIN( 500)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Ian/IAN_Assets",c5,8a,68,9b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 500)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Ian/IAN_Assets",c5,8a,68,9b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 502)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("ian_idle",9d,41,59,2b),24,false,null(),null());
HXLINE( 503)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("ian_up",a4,1c,55,1e),24,false,null(),null());
HXLINE( 504)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("ian_down",eb,92,13,28),24,false,null(),null());
HXLINE( 505)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("ian_back",b0,74,b6,26),24,false,null(),null());
HXLINE( 506)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("ian_forward",dc,c2,af,7a),24,false,null(),null());
HXLINE( 508)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 509)			this->addOffset(HX_("singUP",6a,52,21,b9),0,0);
HXLINE( 510)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),0,0);
HXLINE( 511)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),0,0);
HXLINE( 512)			this->addOffset(HX_("singDOWN",31,2a,ad,36),0,0);
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 517)		this->dance();
HXLINE( 519)		if (( (bool)(isPlayer) )) {
HXLINE( 521)			this->set_flipX(!(this->flipX));
HXLINE( 524)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 527)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 528)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 529)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_543_update)
HXLINE( 544)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 546)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 548)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 548)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 551)			Float dadVar = ( (Float)(4) );
HXLINE( 553)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 554)				dadVar = ((Float)6.1);
            			}
HXLINE( 555)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 557)				this->dance();
HXLINE( 558)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 562)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 565)			bool _hx_tmp;
HXDLIN( 565)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 565)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
HXLINE( 565)				_hx_tmp = false;
            			}
HXDLIN( 565)			if (_hx_tmp) {
HXLINE( 566)				this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            			}
            		}
HXLINE( 569)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_579_dance)
HXDLIN( 579)		if (!(this->debugMode)) {
HXLINE( 581)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 584)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 586)					this->danced = !(this->danced);
HXLINE( 588)					if (this->danced) {
HXLINE( 589)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 591)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 584)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
...
HXLINE( 616)				goto _hx_goto_21;
            			...
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 627)				this->danced = !(this->danced);
HXLINE( 629)				if (this->danced) {
HXLINE( 630)					this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            				}
            				else {
HXLINE( 632)					this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            				}
HXLINE( 626)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 634)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_640_playAnim)
HXLINE( 641)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 643)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 644)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 646)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 649)			this->offset->set(0,0);
            		}
HXLINE( 651)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 653)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 655)				this->danced = true;
            			}
            			else {
HXLINE( 657)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 659)					this->danced = false;
            				}
            			}
HXLINE( 662)			bool _hx_tmp;
HXDLIN( 662)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 662)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 662)				_hx_tmp = true;
            			}
HXDLIN( 662)			if (_hx_tmp) {
HXLINE( 664)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_671_addOffset)
HXDLIN( 671)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 671)		this->animOffsets->set(name,v);
            	}
