...
HXLINE(2461)			if (::hx::IsEq( this->_hx___mouseDownMiddle,target )) {
...
HXLINE(2392)				if (::hx::IsNotEq( this->get_focus(),target )) {
...
HXLINE(2436)				if (::hx::IsEq( this->_hx___mouseDownLeft,target )) {
...
HXLINE(2469)			if (::hx::IsEq( this->_hx___mouseDownRight,target )) {
...
HXLINE(2564)		if (::hx::IsNotEq( target,this->_hx___mouseOverTarget )) {
...
HXLINE(2641)		if (::hx::IsNotEq( target,this->_hx___mouseOverTarget )) {
...
HXLINE(2668)			if (::hx::IsEq( this->_hx___mouseOverTarget,this->_hx___dragObject )) {
...
HXLINE(2686)				if (::hx::IsNotEq( this->_hx___mouseOverTarget,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE(2781)			if (::hx::IsEq( touchData->touchDownTarget,target )) {
...
HXDLIN(2812)		if (::hx::IsNotEq( target,touchOverTarget )) {
...
HXLINE(2870)		if (::hx::IsNotEq( target,touchOverTarget )) {
...
HXLINE(3214)		if (::hx::IsNotEq( value,this->_hx___focus )) {
