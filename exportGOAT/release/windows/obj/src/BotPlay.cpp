...
HXDLIN( 598)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("sourceGOAT/Options.hx",79,0f,cd,63),598,HX_("BotPlay",7b,4f,d4,19),HX_("press",83,53,88,c8)));
...
HXDLIN( 604)		::String _hx_tmp;
HXDLIN( 604)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic)) )) {
HXDLIN( 604)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 604)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 604)		return (HX_("BotPlay ",45,3c,f1,7f) + _hx_tmp);
            	}
