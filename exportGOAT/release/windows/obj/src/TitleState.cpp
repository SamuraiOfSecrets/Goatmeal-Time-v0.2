...
static const ::String _hx_array_data_8ca18d79_21[] = {
	HX_("A mod",63,9f,85,82),HX_("by",d7,55,00,00),
};
...
HXDLIN(  64)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("sourceGOAT/TitleState.hx",4c,e3,52,6a),64,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
...
HXLINE( 166)		this->logoBl =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,10,null());
...
HXLINE( 177)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("Title Bop instance 1",ab,ab,c7,2f),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 178)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("Title Bop instance 1",ab,ab,c7,2f),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_7,15),HX_("",00,00,00,00),24,false,null(),null());
...
HXLINE( 321)						::haxe::Log_obj::trace((((HX_("outdated lmao! ",46,1a,a2,c7) + returnedData->__get(0)) + HX_(" != ",84,13,40,15)) + ::MainMenuState_obj::kadeEngineVer),::hx::SourceInfo(HX_("sourceGOAT/TitleState.hx",4c,e3,52,6a),321,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
...
HXLINE( 333)					::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("sourceGOAT/TitleState.hx",4c,e3,52,6a),333,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 334)					{
...
HXLINE( 415)					this->addMoreText(HX_("SamuraiOfSecrets",08,f3,37,d3));
            				}
            				else {
...
HXLINE( 436)				this->deleteCoolText();
            			...
            			break;
            			case (int)13: {
HXLINE( 441)				this->addMoreText(HX_("Its",08,ca,37,00));
            			}
            			break;
            			case (int)14: {
HXLINE( 444)				this->addMoreText(HX_("Goatmeal",fe,a8,3e,c0));
            			}
            			break;
            			case (int)15: {
HXLINE( 447)				this->addMoreText(HX_("Time",2d,f8,d5,37));
            			}
            			break;
            			case (int)16: {
