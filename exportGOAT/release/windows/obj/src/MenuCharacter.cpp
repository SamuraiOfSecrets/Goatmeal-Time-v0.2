...
HXLINE(  56)		this->animation->addByPrefix(HX_("goatmeal",de,ec,8c,e6),HX_("Goat",3b,b5,42,2f),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("bf",c4,55,00,00), ::CharacterSetting_obj::__alloc( HX_CTX ,0,10,((Float)0.8),true));
HXDLIN(  24)			_g->set(HX_("gf",1f,5a,00,00), ::CharacterSetting_obj::__alloc( HX_CTX ,50,0,((Float)1.5),true));
...
HXDLIN(  24)			_g->set(HX_("goatmeal",de,ec,8c,e6), ::CharacterSetting_obj::__alloc( HX_CTX ,-75,0,((Float)1.2),null()));
HXDLIN(  24)			return _g;
            		}
