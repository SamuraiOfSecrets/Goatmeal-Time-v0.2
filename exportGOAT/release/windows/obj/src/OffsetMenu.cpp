...
HXLINE( 569)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("sourceGOAT/Options.hx",79,0f,cd,63),569,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
...
HXLINE( 577)		::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("sourceGOAT/Options.hx",79,0f,cd,63),577,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE( 578)		{
